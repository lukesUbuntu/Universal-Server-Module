...
<div align="center">
    <div id="loginForm" align="left" style="width: 100%; margin: 0px; border: none;">
            <div id="loginFormContent" style="background-color: #fff !important;">
...
<?php
            echo $lang_ftp_host;
?>:
<br><input type="text" class="form-control" name="ftp_host" value="<?php
...
<?php
            echo $lang_port;
?>:
<br><input type="text" class="form-control" name="ftp_port" value="<?php
...
<?php
        echo $lang_username;
?>:
<br><input type="text" class="form-control" name="ftp_user" value="<?php
...
<p><?php
        echo $lang_password;
?>:
<br><input type="password" class="form-control" name="ftp_pass" value="<?php
...
<?php
    if ($type == "manual") {
?>
<input type="text" class="form-control" size="4" name="chmodNum" id="chmodNum" value="<?php
        echo $chmod;
